...
/**
 * Criteria class for the {@link org.cidha.domain.Data} entity. This class is used
 * in {@link org.cidha.web.rest.DataResource} to receive all the possible filtering options from
...
public class DataCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, data, tipoDataId, processoId, distinct);
    }
