...
/**
 * Criteria class for the {@link org.cidha.domain.Recurso} entity. This class is used
 * in {@link org.cidha.web.rest.RecursoResource} to receive all the possible filtering options from
...
public class RecursoCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, tipoRecursoId, opcaoRecursoId, processoId, distinct);
    }
