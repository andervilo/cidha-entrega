...
/**
 * Criteria class for the {@link org.cidha.domain.TerraIndigena} entity. This class is used
 * in {@link org.cidha.web.rest.TerraIndigenaResource} to receive all the possible filtering options from
...
public class TerraIndigenaCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, etniaId, processoId, distinct);
    }
