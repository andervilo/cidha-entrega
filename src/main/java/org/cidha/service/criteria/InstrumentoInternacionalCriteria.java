...
/**
 * Criteria class for the {@link org.cidha.domain.InstrumentoInternacional} entity. This class is used
 * in {@link org.cidha.web.rest.InstrumentoInternacionalResource} to receive all the possible filtering options from
...
public class InstrumentoInternacionalCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, folhasInstrumentoInternacional, problemaJuridicoId, distinct);
    }
