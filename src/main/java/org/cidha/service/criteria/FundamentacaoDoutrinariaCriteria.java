...
/**
 * Criteria class for the {@link org.cidha.domain.FundamentacaoDoutrinaria} entity. This class is used
 * in {@link org.cidha.web.rest.FundamentacaoDoutrinariaResource} to receive all the possible filtering options from
...
public class FundamentacaoDoutrinariaCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, folhasFundamentacaoDoutrinaria, problemaJuridicoId, distinct);
    }
