...
/**
 * Criteria class for the {@link org.cidha.domain.ProcessoConflito} entity. This class is used
 * in {@link org.cidha.web.rest.ProcessoConflitoResource} to receive all the possible filtering options from
...
public class ProcessoConflitoCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nomeCasoComuidade, consultaPrevia, conflitoId, direitoId, processoId, distinct);
    }
