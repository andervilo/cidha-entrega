...
/**
 * Criteria class for the {@link org.cidha.domain.FundamentacaoLegal} entity. This class is used
 * in {@link org.cidha.web.rest.FundamentacaoLegalResource} to receive all the possible filtering options from
...
public class FundamentacaoLegalCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, folhasFundamentacaoLegal, problemaJuridicoId, distinct);
    }
