...
/**
 * Criteria class for the {@link org.cidha.domain.RepresentanteLegal} entity. This class is used
 * in {@link org.cidha.web.rest.RepresentanteLegalResource} to receive all the possible filtering options from
...
public class RepresentanteLegalCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nome, tipoRepresentanteId, processoConflitoId, distinct);
    }
