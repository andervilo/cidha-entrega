...
/**
 * Criteria class for the {@link org.cidha.domain.EnvolvidosConflitoLitigio} entity. This class is used
 * in {@link org.cidha.web.rest.EnvolvidosConflitoLitigioResource} to receive all the possible filtering options from
...
public class EnvolvidosConflitoLitigioCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, numeroIndividuos, processoId, distinct);
    }
