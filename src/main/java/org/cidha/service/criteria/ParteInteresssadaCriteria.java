...
/**
 * Criteria class for the {@link org.cidha.domain.ParteInteresssada} entity. This class is used
 * in {@link org.cidha.web.rest.ParteInteresssadaResource} to receive all the possible filtering options from
...
public class ParteInteresssadaCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nome, classificacao, representanteLegalId, processoId, distinct);
    }
