...
/**
 * Criteria class for the {@link org.cidha.domain.Municipio} entity. This class is used
 * in {@link org.cidha.web.rest.MunicipioResource} to receive all the possible filtering options from
...
public class MunicipioCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, amazoniaLegal, codigoIbge, estado, nome, processoId, distinct);
    }
