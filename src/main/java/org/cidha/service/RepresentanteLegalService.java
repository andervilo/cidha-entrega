...
public class RepresentanteLegalService {
    ...
    /**
     * Update a representanteLegal.
     *
     * @param representanteLegal the entity to save.
     * @return the persisted entity.
     */
    public RepresentanteLegal update(RepresentanteLegal representanteLegal) {
        log.debug("Request to save RepresentanteLegal : {}", representanteLegal);
        return representanteLegalRepository.save(representanteLegal);
    }
    ...
    public Optional<RepresentanteLegal> partialUpdate(RepresentanteLegal representanteLegal) {
        ...
        return representanteLegalRepository
            ...
            .map(existingRepresentanteLegal -> {
    ...
    /**
     * Get all the representanteLegals with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<RepresentanteLegal> findAllWithEagerRelationships(Pageable pageable) {
        return representanteLegalRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<RepresentanteLegal> findOne(Long id) {
        ...
        return representanteLegalRepository.findOneWithEagerRelationships(id);
    }
