...
public class RecursoService {
    ...
    /**
     * Get all the recursos with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<Recurso> findAllWithEagerRelationships(Pageable pageable) {
        return recursoRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<Recurso> findOne(Long id) {
        ...
        return recursoRepository.findOneWithEagerRelationships(id);
    }
