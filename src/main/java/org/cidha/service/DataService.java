...
public class DataService {
    ...
    /**
     * Get all the data with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<Data> findAllWithEagerRelationships(Pageable pageable) {
        return dataRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<Data> findOne(Long id) {
        ...
        return dataRepository.findOneWithEagerRelationships(id);
    }
