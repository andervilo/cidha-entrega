...
import org.cidha.repository.UnidadeConservacaoRepository;
import org.cidha.service.UnidadeConservacaoQueryService;
import org.cidha.service.UnidadeConservacaoService;
import org.cidha.service.criteria.UnidadeConservacaoCriteria;
...
/**
 * REST controller for managing {@link org.cidha.domain.UnidadeConservacao}.
 */
@RestController
@RequestMapping("/api")
public class UnidadeConservacaoResource {
    ...
    public ResponseEntity<UnidadeConservacao> updateUnidadeConservacao(
        ...
        UnidadeConservacao result = unidadeConservacaoService.update(unidadeConservacao);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<List<UnidadeConservacao>> getAllUnidadeConservacaos(
        UnidadeConservacaoCriteria criteria,
