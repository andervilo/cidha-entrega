...
import org.cidha.repository.EtniaIndigenaRepository;
import org.cidha.service.EtniaIndigenaQueryService;
import org.cidha.service.EtniaIndigenaService;
import org.cidha.service.criteria.EtniaIndigenaCriteria;
...
/**
 * REST controller for managing {@link org.cidha.domain.EtniaIndigena}.
 */
@RestController
@RequestMapping("/api")
public class EtniaIndigenaResource {
    ...
    public ResponseEntity<EtniaIndigena> updateEtniaIndigena(
        ...
        EtniaIndigena result = etniaIndigenaService.update(etniaIndigena);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, etniaIndigena.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/etnia-indigenas/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<EtniaIndigena> partialUpdateEtniaIndigena(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, etniaIndigena.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<EtniaIndigena>> getAllEtniaIndigenas(
        EtniaIndigenaCriteria criteria,
