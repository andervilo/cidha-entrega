...
import org.cidha.service.TipoRepresentanteQueryService;
import org.cidha.service.TipoRepresentanteService;
...
/**
 * REST controller for managing {@link org.cidha.domain.TipoRepresentante}.
 */
@RestController
@RequestMapping("/api")
public class TipoRepresentanteResource {
    ...
    public ResponseEntity<TipoRepresentante> updateTipoRepresentante(
        ...
        TipoRepresentante result = tipoRepresentanteService.update(tipoRepresentante);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tipoRepresentante.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/tipo-representantes/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<TipoRepresentante> partialUpdateTipoRepresentante(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tipoRepresentante.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<TipoRepresentante>> getAllTipoRepresentantes(
        TipoRepresentanteCriteria criteria,
