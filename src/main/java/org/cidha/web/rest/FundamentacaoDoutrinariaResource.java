...
import org.cidha.service.FundamentacaoDoutrinariaQueryService;
import org.cidha.service.FundamentacaoDoutrinariaService;
import org.cidha.service.criteria.FundamentacaoDoutrinariaCriteria;
...
/**
 * REST controller for managing {@link org.cidha.domain.FundamentacaoDoutrinaria}.
 */
@RestController
@RequestMapping("/api")
public class FundamentacaoDoutrinariaResource {
    ...
    public ResponseEntity<FundamentacaoDoutrinaria> updateFundamentacaoDoutrinaria(
        ...
        FundamentacaoDoutrinaria result = fundamentacaoDoutrinariaService.update(fundamentacaoDoutrinaria);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, fundamentacaoDoutrinaria.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/fundamentacao-doutrinarias/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<FundamentacaoDoutrinaria> partialUpdateFundamentacaoDoutrinaria(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, fundamentacaoDoutrinaria.getId().toString())
        );
    }
