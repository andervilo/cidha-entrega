...
import org.cidha.repository.InstrumentoInternacionalRepository;
import org.cidha.service.InstrumentoInternacionalQueryService;
import org.cidha.service.InstrumentoInternacionalService;
import org.cidha.service.criteria.InstrumentoInternacionalCriteria;
...
/**
 * REST controller for managing {@link org.cidha.domain.InstrumentoInternacional}.
 */
@RestController
@RequestMapping("/api")
public class InstrumentoInternacionalResource {
    ...
    public ResponseEntity<InstrumentoInternacional> updateInstrumentoInternacional(
        ...
        InstrumentoInternacional result = instrumentoInternacionalService.update(instrumentoInternacional);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, instrumentoInternacional.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/instrumento-internacionals/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<InstrumentoInternacional> partialUpdateInstrumentoInternacional(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, instrumentoInternacional.getId().toString())
        );
    }
