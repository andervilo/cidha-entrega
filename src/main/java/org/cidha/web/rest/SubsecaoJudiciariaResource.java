...
import org.cidha.repository.SubsecaoJudiciariaRepository;
...
/**
 * REST controller for managing {@link org.cidha.domain.SubsecaoJudiciaria}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SubsecaoJudiciariaResource {
    ...
    public ResponseEntity<SubsecaoJudiciaria> updateSubsecaoJudiciaria(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, subsecaoJudiciaria.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/subsecao-judiciarias/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<SubsecaoJudiciaria> partialUpdateSubsecaoJudiciaria(
        ...
        Optional<SubsecaoJudiciaria> result = subsecaoJudiciariaRepository
            ...
            .map(existingSubsecaoJudiciaria -> {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, subsecaoJudiciaria.getId().toString())
        );
    }
