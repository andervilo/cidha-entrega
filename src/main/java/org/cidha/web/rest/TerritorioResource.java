...
import org.cidha.repository.TerritorioRepository;
import org.cidha.service.TerritorioQueryService;
import org.cidha.service.TerritorioService;
import org.cidha.service.criteria.TerritorioCriteria;
...
/**
 * REST controller for managing {@link org.cidha.domain.Territorio}.
 */
@RestController
@RequestMapping("/api")
public class TerritorioResource {
    ...
    public ResponseEntity<Territorio> updateTerritorio(
        ...
        Territorio result = territorioService.update(territorio);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, territorio.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/territorios/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<Territorio> partialUpdateTerritorio(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, territorio.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<Territorio>> getAllTerritorios(
        TerritorioCriteria criteria,
