...
import org.cidha.repository.TipoEmpreendimentoRepository;
import org.cidha.service.TipoEmpreendimentoQueryService;
import org.cidha.service.TipoEmpreendimentoService;
import org.cidha.service.criteria.TipoEmpreendimentoCriteria;
...
/**
 * REST controller for managing {@link org.cidha.domain.TipoEmpreendimento}.
 */
@RestController
@RequestMapping("/api")
public class TipoEmpreendimentoResource {
    ...
    public ResponseEntity<TipoEmpreendimento> updateTipoEmpreendimento(
        ...
        TipoEmpreendimento result = tipoEmpreendimentoService.update(tipoEmpreendimento);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tipoEmpreendimento.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/tipo-empreendimentos/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<TipoEmpreendimento> partialUpdateTipoEmpreendimento(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tipoEmpreendimento.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<TipoEmpreendimento>> getAllTipoEmpreendimentos(
        TipoEmpreendimentoCriteria criteria,
