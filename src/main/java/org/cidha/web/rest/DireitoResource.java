...
import org.cidha.repository.DireitoRepository;
import org.cidha.service.DireitoQueryService;
import org.cidha.service.DireitoService;
import org.cidha.service.criteria.DireitoCriteria;
...
/**
 * REST controller for managing {@link org.cidha.domain.Direito}.
 */
@RestController
@RequestMapping("/api")
public class DireitoResource {
    ...
    public ResponseEntity<Direito> updateDireito(@PathVariable(value = "id", required = false) final Long id, @RequestBody Direito direito)
        ...
        Direito result = direitoService.update(direito);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, direito.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/direitos/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<Direito> partialUpdateDireito(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, direito.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/direitos")
    public ResponseEntity<List<Direito>> getAllDireitos(
        DireitoCriteria criteria,
