...
import org.cidha.service.FundamentacaoLegalQueryService;
import org.cidha.service.FundamentacaoLegalService;
import org.cidha.service.criteria.FundamentacaoLegalCriteria;
...
/**
 * REST controller for managing {@link org.cidha.domain.FundamentacaoLegal}.
 */
@RestController
@RequestMapping("/api")
public class FundamentacaoLegalResource {
    ...
    public ResponseEntity<FundamentacaoLegal> updateFundamentacaoLegal(
        ...
        FundamentacaoLegal result = fundamentacaoLegalService.update(fundamentacaoLegal);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, fundamentacaoLegal.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/fundamentacao-legals/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<FundamentacaoLegal> partialUpdateFundamentacaoLegal(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, fundamentacaoLegal.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<FundamentacaoLegal>> getAllFundamentacaoLegals(
        FundamentacaoLegalCriteria criteria,
