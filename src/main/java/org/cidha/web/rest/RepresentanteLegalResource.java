...
import org.cidha.service.RepresentanteLegalQueryService;
...
/**
 * REST controller for managing {@link org.cidha.domain.RepresentanteLegal}.
 */
@RestController
@RequestMapping("/api")
public class RepresentanteLegalResource {
    ...
    public ResponseEntity<RepresentanteLegal> updateRepresentanteLegal(
        ...
        RepresentanteLegal result = representanteLegalService.update(representanteLegal);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, representanteLegal.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/representante-legals/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<RepresentanteLegal> partialUpdateRepresentanteLegal(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, representanteLegal.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<RepresentanteLegal>> getAllRepresentanteLegals(
        RepresentanteLegalCriteria criteria,
