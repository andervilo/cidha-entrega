...
import org.cidha.repository.EnvolvidosConflitoLitigioRepository;
import org.cidha.service.EnvolvidosConflitoLitigioQueryService;
import org.cidha.service.EnvolvidosConflitoLitigioService;
import org.cidha.service.criteria.EnvolvidosConflitoLitigioCriteria;
...
/**
 * REST controller for managing {@link org.cidha.domain.EnvolvidosConflitoLitigio}.
 */
@RestController
@RequestMapping("/api")
public class EnvolvidosConflitoLitigioResource {
    ...
    public ResponseEntity<EnvolvidosConflitoLitigio> updateEnvolvidosConflitoLitigio(
        ...
        EnvolvidosConflitoLitigio result = envolvidosConflitoLitigioService.update(envolvidosConflitoLitigio);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, envolvidosConflitoLitigio.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/envolvidos-conflito-litigios/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<EnvolvidosConflitoLitigio> partialUpdateEnvolvidosConflitoLitigio(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, envolvidosConflitoLitigio.getId().toString())
        );
    }
