...
import org.cidha.repository.ConcessaoLiminarRepository;
import org.cidha.service.ConcessaoLiminarQueryService;
import org.cidha.service.ConcessaoLiminarService;
import org.cidha.service.criteria.ConcessaoLiminarCriteria;
...
/**
 * REST controller for managing {@link org.cidha.domain.ConcessaoLiminar}.
 */
@RestController
@RequestMapping("/api")
public class ConcessaoLiminarResource {
    ...
    public ResponseEntity<ConcessaoLiminar> updateConcessaoLiminar(
        ...
        ConcessaoLiminar result = concessaoLiminarService.update(concessaoLiminar);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, concessaoLiminar.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/concessao-liminars/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<ConcessaoLiminar> partialUpdateConcessaoLiminar(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, concessaoLiminar.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<ConcessaoLiminar>> getAllConcessaoLiminars(
        ConcessaoLiminarCriteria criteria,
