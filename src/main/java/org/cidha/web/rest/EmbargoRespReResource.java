...
import org.cidha.repository.EmbargoRespReRepository;
import org.cidha.service.EmbargoRespReQueryService;
import org.cidha.service.EmbargoRespReService;
import org.cidha.service.criteria.EmbargoRespReCriteria;
...
/**
 * REST controller for managing {@link org.cidha.domain.EmbargoRespRe}.
 */
@RestController
@RequestMapping("/api")
public class EmbargoRespReResource {
    ...
    public ResponseEntity<EmbargoRespRe> updateEmbargoRespRe(
        ...
        EmbargoRespRe result = embargoRespReService.update(embargoRespRe);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, embargoRespRe.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/embargo-resp-res/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<EmbargoRespRe> partialUpdateEmbargoRespRe(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, embargoRespRe.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<EmbargoRespRe>> getAllEmbargoRespRes(
        EmbargoRespReCriteria criteria,
