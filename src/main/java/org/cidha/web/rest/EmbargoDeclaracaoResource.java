...
import org.cidha.service.EmbargoDeclaracaoQueryService;
import org.cidha.service.EmbargoDeclaracaoService;
...
/**
 * REST controller for managing {@link org.cidha.domain.EmbargoDeclaracao}.
 */
@RestController
@RequestMapping("/api")
public class EmbargoDeclaracaoResource {
    ...
    public ResponseEntity<EmbargoDeclaracao> updateEmbargoDeclaracao(
        ...
        EmbargoDeclaracao result = embargoDeclaracaoService.update(embargoDeclaracao);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, embargoDeclaracao.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/embargo-declaracaos/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<EmbargoDeclaracao> partialUpdateEmbargoDeclaracao(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, embargoDeclaracao.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<EmbargoDeclaracao>> getAllEmbargoDeclaracaos(
        EmbargoDeclaracaoCriteria criteria,
