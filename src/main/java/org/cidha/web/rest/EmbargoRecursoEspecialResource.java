...
import org.cidha.service.EmbargoRecursoEspecialQueryService;
import org.cidha.service.EmbargoRecursoEspecialService;
...
/**
 * REST controller for managing {@link org.cidha.domain.EmbargoRecursoEspecial}.
 */
@RestController
@RequestMapping("/api")
public class EmbargoRecursoEspecialResource {
    ...
    public ResponseEntity<EmbargoRecursoEspecial> updateEmbargoRecursoEspecial(
        ...
        EmbargoRecursoEspecial result = embargoRecursoEspecialService.update(embargoRecursoEspecial);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, embargoRecursoEspecial.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/embargo-recurso-especials/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<EmbargoRecursoEspecial> partialUpdateEmbargoRecursoEspecial(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, embargoRecursoEspecial.getId().toString())
        );
    }
