...
import org.cidha.repository.EmbargoDeclaracaoAgravoRepository;
import org.cidha.service.EmbargoDeclaracaoAgravoQueryService;
import org.cidha.service.EmbargoDeclaracaoAgravoService;
import org.cidha.service.criteria.EmbargoDeclaracaoAgravoCriteria;
...
/**
 * REST controller for managing {@link org.cidha.domain.EmbargoDeclaracaoAgravo}.
 */
@RestController
@RequestMapping("/api")
public class EmbargoDeclaracaoAgravoResource {
    ...
    public ResponseEntity<EmbargoDeclaracaoAgravo> updateEmbargoDeclaracaoAgravo(
        ...
        EmbargoDeclaracaoAgravo result = embargoDeclaracaoAgravoService.update(embargoDeclaracaoAgravo);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, embargoDeclaracaoAgravo.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/embargo-declaracao-agravos/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<EmbargoDeclaracaoAgravo> partialUpdateEmbargoDeclaracaoAgravo(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, embargoDeclaracaoAgravo.getId().toString())
        );
    }
