...
import org.cidha.service.TipoRecursoQueryService;
import org.cidha.service.TipoRecursoService;
...
/**
 * REST controller for managing {@link org.cidha.domain.TipoRecurso}.
 */
@RestController
@RequestMapping("/api")
public class TipoRecursoResource {
    ...
    public ResponseEntity<TipoRecurso> updateTipoRecurso(
        ...
        TipoRecurso result = tipoRecursoService.update(tipoRecurso);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tipoRecurso.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/tipo-recursos/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<TipoRecurso> partialUpdateTipoRecurso(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tipoRecurso.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<TipoRecurso>> getAllTipoRecursos(
        TipoRecursoCriteria criteria,
