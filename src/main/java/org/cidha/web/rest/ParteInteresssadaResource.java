...
import org.cidha.service.ParteInteresssadaQueryService;
import org.cidha.service.ParteInteresssadaService;
import org.cidha.service.criteria.ParteInteresssadaCriteria;
...
/**
 * REST controller for managing {@link org.cidha.domain.ParteInteresssada}.
 */
@RestController
@RequestMapping("/api")
public class ParteInteresssadaResource {
    ...
    public ResponseEntity<ParteInteresssada> updateParteInteresssada(
        ...
        ParteInteresssada result = parteInteresssadaService.update(parteInteresssada);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, parteInteresssada.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/parte-interesssadas/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<ParteInteresssada> partialUpdateParteInteresssada(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, parteInteresssada.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<ParteInteresssada>> getAllParteInteresssadas(
        ParteInteresssadaCriteria criteria,
