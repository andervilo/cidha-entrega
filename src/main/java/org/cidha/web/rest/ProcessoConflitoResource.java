...
import org.cidha.repository.ProcessoConflitoRepository;
import org.cidha.service.ProcessoConflitoQueryService;
import org.cidha.service.ProcessoConflitoService;
import org.cidha.service.criteria.ProcessoConflitoCriteria;
...
/**
 * REST controller for managing {@link org.cidha.domain.ProcessoConflito}.
 */
@RestController
@RequestMapping("/api")
public class ProcessoConflitoResource {
    ...
    public ResponseEntity<ProcessoConflito> updateProcessoConflito(
        ...
        ProcessoConflito result = processoConflitoService.update(processoConflito);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, processoConflito.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/processo-conflitos/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<ProcessoConflito> partialUpdateProcessoConflito(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, processoConflito.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<ProcessoConflito>> getAllProcessoConflitos(
        ProcessoConflitoCriteria criteria,
