...
export class RecursoComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.recursoService
      ...
      .subscribe({
        next: (res: HttpResponse<IRecurso[]>) => {
  ...
  trackId(_index: number, item: IRecurso): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IRecurso[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
