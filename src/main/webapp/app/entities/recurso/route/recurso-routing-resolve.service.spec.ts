...
describe('Recurso routing resolve service', () => {
  ...
  let resultRecurso: IRecurso | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IRecurso if id is not provided', () => {
      // GIVEN
      ...
      expect(resultRecurso).toEqual(new Recurso());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Recurso })));
      mockActivatedRouteSnapshot.params = { id: 123 };
