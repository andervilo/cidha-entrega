...
export class TipoRecursoComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.tipoRecursoService
      ...
      .subscribe({
        next: (res: HttpResponse<ITipoRecurso[]>) => {
  ...
  trackId(_index: number, item: ITipoRecurso): number {
    return item.id!;
  }

  delete(tipoRecurso: ITipoRecurso): void {
    const modalRef = this.modalService.open(TipoRecursoDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: ITipoRecurso[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
