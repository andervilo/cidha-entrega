...
describe('TipoRecurso Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'tipo-recurso', component: TipoRecursoComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tipoRecursos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
