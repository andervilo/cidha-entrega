...
describe('Jurisprudencia Management Component', () => {
  let comp: JurisprudenciaComponent;
  let fixture: ComponentFixture<JurisprudenciaComponent>;
  let service: JurisprudenciaService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'jurisprudencia', component: JurisprudenciaComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(JurisprudenciaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.jurisprudencias?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
