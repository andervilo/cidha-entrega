...
describe('Direito Management Component', () => {
  let comp: DireitoComponent;
  let fixture: ComponentFixture<DireitoComponent>;
  let service: DireitoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'direito', component: DireitoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(DireitoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.direitos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
