...
describe('RepresentanteLegal Management Component', () => {
  let comp: RepresentanteLegalComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'representante-legal', component: RepresentanteLegalComponent }]),
      ...
      .overrideTemplate(RepresentanteLegalComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.representanteLegals?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
