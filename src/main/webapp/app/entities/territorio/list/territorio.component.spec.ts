...
describe('Territorio Management Component', () => {
  let comp: TerritorioComponent;
  let fixture: ComponentFixture<TerritorioComponent>;
  let service: TerritorioService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'territorio', component: TerritorioComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(TerritorioComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.territorios?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
